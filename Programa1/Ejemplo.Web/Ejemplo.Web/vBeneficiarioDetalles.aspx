        ...
        <asp:TableRow VerticalAlign="Top">
            ...
            <asp:TableCell Width="70%">
                <asp:Table runat="server">
                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:GridView ID="grdUltimosDiagnosticos" runat="server" ShowHeaderWhenEmpty="true">
                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:GridView ID="grdPlanesActivos" runat="server" ShowHeaderWhenEmpty="true"
                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:GridView ID="grdInformes" runat="server" ShowHeaderWhenEmpty="true">
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <EditRowStyle BackColor="#999999" />
                                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                                <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:GridView ID="grdPlanesInactivos" runat="server" ShowHeaderWhenEmpty="true"
                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            <asp:GridView ID="grdHistorialDiagnosticos" runat="server" ShowHeaderWhenEmpty="true">
                                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                <EditRowStyle BackColor="#999999" />
                                <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                                <HeaderStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
