        ...
        <tr>
            ...
            <td>
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="grdDiagnosticos" runat="server" AutoGenerateDeleteButton="True" OnRowDeleting="grdDiagnosticos_RowDeleting" OnRowCreated="grdDiagnosticos_RowCreated"></asp:GridView>
                        </td>
                    </tr>
                </table>
            </td>
