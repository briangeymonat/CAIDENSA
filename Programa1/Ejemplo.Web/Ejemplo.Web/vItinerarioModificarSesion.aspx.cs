...
namespace Ejemplo.Web
{
    public partial class vItinerarioModificarConsulta : System.Web.UI.Page
    {
        ...
        private void CargarTodo()
        {
            ...
            txtDesde.Enabled = modificando;
            txtHasta.Enabled = modificando;
        ...
        private void CargarDatos()
        {
            ...
            txtDesde.Text = ElItinerario.HoraInicio;
            txtHasta.Text = ElItinerario.HoraFin;
        ...
        private bool FaltanDatos()
        {
            if (txtDesde.Text == string.Empty ||
                ...
                ElItinerario.lstBeneficiarios.Count <= 0 ||
        ...
        protected void btnConfirmar_Click(object sender, EventArgs e)
        {
            if(!FaltanDatos())
            {
                ...
                else
                {
                    ...
                    {
                        // HORARIO
                        ElItinerario.HoraInicio = txtDesde.Text;
                        ElItinerario.HoraFin = txtHasta.Text;
                        ...
                        {
                            if (dFachada.ItinerarioModificar(ElItinerario)) { CargarTodo(); dFachada.SesionAgregarSesionesDelDia(); }
                            else
                            {
